...
axR.set_title("Zoomed: NVFP4 tracks BF16 (100M-token iso-token slice)")
...
fig.suptitle("NVFP4 vs BF16 scaling law on real text (OpenWebText) — RTX PRO 6000, sm_120\n"
             "nanoGPT-style decoder, iso-token budget ~100M tok/model", fontsize=12)
fig.tight_layout(rect=[0, 0, 1, 0.96])
OUT = "/home/infatoshi/data/scaling_law_100M.png"
